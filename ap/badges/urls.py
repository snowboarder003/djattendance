...
urlpatterns = patterns(
    ...
    url(r'^printterm/$', views.BadgePrintFrontView.as_view(), name='badges_print_term_front'),
    url(r'^printterm/back/$', views.BadgePrintBackView.as_view(), name='badges_print_term_back'),
    url(r'^printterm/facebook/$', views.BadgePrintFacebookView.as_view(), name='badges_print_term_facebook'),
